...
我们可以将排列的数字按顺序插入到空杨表中，这样就会得到一个标准杨表。但是这会出现两个排列对应一个杨表的情况，比如排列 $[2,1,3]$ 和排列 $[2,3,1]$ 都会得到杨表 $\left[\begin{array}{cc}1 & 3 \\ 2 \end{array}\right]$，出大问题。
...
插入 $3$ 得到：
$$
A=\left[\begin{array}{cc}2 & 3 \end{array}\right],
B=\left[\begin{array}{cc}1 & 2 \end{array}\right]
$$
插入 $1$ 得到：
$$
A=\left[\begin{array}{cc}1 & 3 \\ 2 \end{array}\right],
B=\left[\begin{array}{cc}1 & 2 \\ 3 \end{array}\right]
$$
而 $[2,1,3]$ 会得到：
$$
A=\left[\begin{array}{cc}1 & 3 \\ 2 \end{array}\right],
B=\left[\begin{array}{cc}1 & 3 \\ 2 \end{array}\right]
$$
...
比如 $\left[\begin{array}{ccc}1 & 2 & 3 \\ 2 & 1 & 3\end{array}\right]$ 就是个对合置换。
